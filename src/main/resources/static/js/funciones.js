...
function traerInformacionMensaje(){
    $.ajax(
              {
                url: BASE_URL+ 'http://132.226.156.104/api/Message/all',
                type:"GET",
                datatype:"JSON",
                success:function(respuesta){
    ...
    $.ajax (
        {
            ...
            url          : BASE_URL+'http://132.226.156.104/api/Reservation/save',
            type         : 'POST',
            data         :  dataToSend,
            datatype     :  "JSON",
            contentType  : 'application/json',
...
function traerInformacionReservacion(){
    $.ajax(
              {
                url: BASE_URL+'http://132.226.156.104/api/Reservation/all',
                type:"GET",
                datatype:"JSON",
                success:function(respuesta){
